/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 50d4a407a8f9b1dadfbcdee5a73d3e62)
// Runtime types generated with workerd@1.20251125.0 2025-11-28 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SongsDo";
	}
	interface Env {
		ALLOWED_ORIGIN: string;
		SONGS: DurableObjectNamespace<import("./src/index").SongsDo>;
	}
}
